...
def MoveForward(x):
    ...
    pwmB_IN2.ChangeDutyCycle(20*x)
    pwmB_IN4.ChangeDutyCycle(20*x)
    pwmF_IN2.ChangeDutyCycle(20*x)
    pwmF_IN4.ChangeDutyCycle(20*x)
...
def MoveBack(x):
    ...
    pwmB_IN1.ChangeDutyCycle(20*x)
    pwmB_IN3.ChangeDutyCycle(20*x)
    pwmF_IN1.ChangeDutyCycle(20*x)
    pwmF_IN3.ChangeDutyCycle(20*x)
