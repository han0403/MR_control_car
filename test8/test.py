...
def MoveForward():
    ...
    pwmB_IN2.ChangeDutyCycle(90)
    pwmB_IN4.ChangeDutyCycle(90)
    pwmF_IN2.ChangeDutyCycle(90)
    pwmF_IN4.ChangeDutyCycle(90)
...
def MoveBack():
    ...
    pwmB_IN1.ChangeDutyCycle(90)
    pwmB_IN3.ChangeDutyCycle(90)
    pwmF_IN1.ChangeDutyCycle(90)
    pwmF_IN3.ChangeDutyCycle(90)
